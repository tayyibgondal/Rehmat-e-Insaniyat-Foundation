...
class InventoryForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['donation'].queryset = Donation.objects.filter(~Q(used=0))
...
class DonationFormFromDrive(ModelForm):
    first_name = forms.CharField(max_length=30)
    last_name = forms.CharField(max_length=30)
    email = forms.EmailField()
    phone_no = forms.CharField(max_length=30)
    ...
    class Meta:
        model = Donation
        fields = ['first_name', 'last_name', 'email', 'phone_no', 'amount', 'department', 'drive']
        exclude = ['donor', 'department']

class DonationFormFromDept(ModelForm):
    first_name = forms.CharField(max_length=30)
    last_name = forms.CharField(max_length=30)
    email = forms.EmailField()
    phone_no = forms.CharField(max_length=30)
